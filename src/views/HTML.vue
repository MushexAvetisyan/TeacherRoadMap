    ...
    <div class="wrapper">
      <div class="left-side">
        <div class="side-wrapper">
          ...
          <div class="side-menu">
              <div v-for="(item, index) in NavNames" :key="index.id">
                <router-link :to="{path:item.router}">{{item.Title}}</router-link>
              </div>
          </div>
        </div>
      </div>
      <div class="main-container">
        <div class="main-header">
          <div class="header-menu" v-for="(item, index) in Basic" :key="index">
                ...
                <div class="button-wrapper">
                  ...
                  <div class="pop-up">
                    <div class="pop-up__title">Update This App
                      <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather close feather-x-circle">
